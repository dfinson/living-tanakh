...
export default {
  ...
  async getMediaTagsByIds(input, expectedReturn, customHeaders) {
    ...
    if (customHeaders !== undefined)
      requestHeaders = Object.assign({}, requestHeaders, customHeaders);
  ...
  async associateLinkedContentWithMediaTag(
    owner,
    input,
    expectedReturn,
    customHeaders
  ...
  async updateLinkedContentOfMediaTag(
    owner,
    input,
    expectedReturn,
    customHeaders
  ...
  async removeLinkedContentFromMediaTag(
    owner,
    input,
    expectedReturn,
    customHeaders
  ...
  async associateMediaTagsWithVerse(
    owner,
    input,
    expectedReturn,
    customHeaders
